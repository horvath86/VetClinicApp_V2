...
## Future Roadmap
*   **Token-Based Authentication:** Build an HTTP Interceptor to automatically attach JWT security tokens to backend requests after a user logs in.
*   **Route Guards:** Secure application page routes using Angular guards to prevent unauthorized users from manually typing admin URLs into the browser address bar.
