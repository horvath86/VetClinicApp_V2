...
export class TranslationService
{
    ...
    private dictionary = {
        en: {
            ...
            chooseVet: 'Select Veterinarian',
            patientRequired: 'Patient is required',
            vetRequired: 'Veterinarian is required',
            chooseDiagnosis: "Select diagnosis",
            diagRequired: "Diagnosis is required",
            visitDate: 'Visit date',
            dateRequired: 'Date is required',
            symptomsRequired : 'Symptoms are required (max 200 characters)',
            notesOptional: 'Notes (optional)',
            chooseMedication: 'Select medication',
            dosagePlaceholder: 'Dosage details (e.g. 1 pill daily)',
            chooseProcedure: 'Select Procedure',
            durationPlaceholder: 'Minutes',
            anesthesiaPlaceholder: 'Anesthesia details',
            procedurePlaceholder: 'Procedure notes',
            dosageRequired: 'Dosage instructions are required.',
            dosageTooLong: 'Instructions cannot exceed 150 characters.',
            proceduresRequired: 'Procedure notes are required.',
        ...
        sr: {
            ...
            ownerIdRequired: 'Ime vlasnika je obavezno.',
            save: "Snimi",
            saving: 'Snima se...',
            cancel: 'Odustani',
            login: 'Prijava',
            ...
            vet: 'Veterinar',
            choosePatient: 'Izaberite pacijenta',
            chooseVet: 'Izaberite veterinara',
            patientRequired: 'Pacijent je obavezan',
            vetRequired: 'Veterinar je obavezan',
            chooseDiagnosis: "Izaberite dijagnozu",
            diagRequired: "Dijagnoza je obavezna",
            visitDate: 'Datum posete',
            dateRequired: 'Datum je obavezan',
            symptomsRequired: 'Simptomi su obavezni (max 200 karaktera)',
            notesOptional: 'Beleške (opcione)',
            chooseMedication: 'Izaberite lek',
            dosagePlaceholder: 'Detalji o dozi (npr. 1 pilula dnevno)',
            chooseProcedure: 'Izaberite proceduru',
            durationPlaceholder: 'Minuta',
            anesthesiaPlaceholder: 'Detalji o anesteziji',
            procedurePlaceholder: 'Beleške o proceduri',
            dosageRequired: 'Instrukcije o dozi su obavezne.',
            dosageTooLong: 'Instrukcije ne mogu biti duže od 150 karaktera.',
            proceduresRequired: 'Beleške o proceduri su obavezne.',
